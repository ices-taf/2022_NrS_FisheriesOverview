...
effort_NrS$country <- effort_NrS$country.name
effort_NrS$Total.kw.days.at.Sea <- effort_NrS$Total.kW.days.at.sea
df <- effort_NrS
...
plot_stecf <- function(x, type, variable = NULL, cap_year, cap_month, line_count, stecf_report, return_data = FALSE) {
        ...
        # confidential data here, [1] "BEL" "DNK" "ESP" "IRL" "LTU" "NLD" "POL" "PRT"
        ...
        colList <- ggthemes::tableau_color_pal('Tableau 20')(12 + 1)
        ...
        #Plot
plot_stecf(effort_NrS,type = "effort", variable= "COUNTRY", "2019","August", 13, "15-23", return_data = FALSE)
effort_NrS <- dplyr::filter(effort_NrS, country %in% c("Belgium","Germany","Denmark","England and Wales (UK)", "Spain","France",     
                                                       "Ireland","Lithuania","Netherlands",
                                                       "Poland","Portugal ","Scotland","Sweden" ))
# plot_stecf(effort_NrS,type = "effort", variable= "COUNTRY", "2019","August", 9, "15-23", return_data = FALSE)
...
# }
        ...
        #Plot
plot_stecf(effort_NrS,type = "effort", variable= "GEAR", "2019","August", 9, "15-23")
...
plot_stecf <- function(df, type, variable = NULL, cap_year, cap_month, line_count, stecf_report, return_data = FALSE) {
        ...
        #Plot
plot_stecf(landings_NrS,type = "landings", variable= "GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave(paste0(year_cap, "_", ecoreg,"_FO_STECF_landings.png"), path = "report/", width = 178, height = 130, units = "mm", dpi = 300)
        #dat
dat <- plot_stecf(landings_NrS, type = "landings", variable="landings", "2019","August", 9, "15-23", return_data = TRUE)
